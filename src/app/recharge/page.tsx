...
const PACKAGES = [
  ...
  { id: "p3", label: "2000", coins: 2000, priceKes: 240 },
...
export default function RechargePage() {
  ...
  const handleRecharge = async () => {
    ...
    if (!isPesaPalCountry) { router.push(`/coin-sellers?selectedPackage=${selectedPackage.label}&amount=${selectedPackage.coins}`); return; }

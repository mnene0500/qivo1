      ...
      <header className="px-4 h-16 flex items-center justify-between border-b bg-white sticky top-0 z-[70] shrink-0">
        <div className="flex items-center gap-2">
          ...
          <Dialog open={isCurrencyOpen} onOpenChange={setIsCurrencyOpen}>
            ...
            <DialogContent className="rounded-[2.5rem] p-6 max-h-[80vh] flex flex-col border-none shadow-2xl">
      ...
      <main className="flex-1 overflow-y-auto no-scrollbar">
        <div className="p-5 space-y-8 pb-32">
          <div className="flex flex-col items-center gap-2 pt-4">
              ...
              <p className="text-[10px] font-bold text-gray-400 tracking-widest">Available Balance</p>
          </div>

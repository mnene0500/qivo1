...
export default function AgencyMemberPage() {
  ...
  const handleWithdraw = async () => {
    ...
    if (!mpesaNumber || mpesaNumber.length < 10) {
      toast({ variant: "destructive", title: "M-Pesa Required", description: "Provide a valid number for payout." })
      return
    }
          ...
          <div className="p-5 bg-amber-50 rounded-2xl border border-amber-100 flex items-start gap-4">
            ...
            <div className="space-y-1">
              ...
              <p className="text-[9px] font-bold text-amber-700 leading-relaxed uppercase tracking-widest">
                Standard processing charges apply during withdrawal based on Safaricom M-Pesa rates.
              </p>
            </div>
          </div>
